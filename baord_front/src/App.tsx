...
import { AUTH_PATH, BAORD_DETAIL_PATH, BOARD_LIST_PATH, BOARD_UPDATE_PATH, BOARD_WRITE_PATH, MAIN_PATH, REACT_STUDY_PATH, USER_PATH } from './constants';
import Main from './views/Main';
import Board from './views/Board';
import BoardList from './views/Board';
import User from './views/User';
import Authtentication from './views/Authenticaion/index';
import ReactStudy from './views/ReactStudy';
import { useCookies } from 'react-cookie';
import useAuthStore from './stores/auth.store';
import axios from 'axios';
import Authentication from './views/Authenticaion/index';
